...
export function buildClientDrafts(clock: Clock, personFor: (key: ClientKey) => DemoPerson): LeadDraft[] {
  ...
  const madriLanding = wonLead(madri, {
    ...
    acts: [
      ...
      proposalSent('Landing page de lançamento', 2600, past(165, 9)),
  ...
  const madriStore = wonLead(madri, {
    ...
    acts: [
      ...
      proposalSent('E-commerce completo', 11800, past(110, 11)),
  ...
  const socialSite = wonLead(social, {
    ...
    acts: [
      ...
      proposalSent('Site com catálogo de venda e aluguel', 3400, past(137, 9)),
  ...
  const socialBooking: LeadDraft = {
    ...
    acts: [
      ...
      diagnosisMeeting(social.company, social.person, { min: 6000, max: 7500 }, past(18, 15)),
  ...
  const mariaLanding = wonLead(maria, {
    ...
    acts: [
      ...
      proposalSent('Landing page de procedimentos', 2900, past(96, 10)),
  ...
  const mariaSeo: LeadDraft = {
    ...
    acts: [
      ...
      proposalSent('Google Meu Negócio + SEO local', 1600, mariaProposal),
  ...
  const alicerceSystem = wonLead(alicerce, {
    ...
    acts: [
      ...
      proposalSent('Sistema restrito de agendamentos', 9800, past(66, 10)),
      ...
      proposalSent('Sistema restrito de agendamentos (revisada)', 9500, past(61, 11)),
